      ...
      <article id="page-default-banner-section">
        <div id="page-default-banner-image" class="visible-lg visible-md">
          <div class="manic-image-container">
            <img src="" data-image-desktop="images_cms/rest/rest-banner.jpg">
          </div>
        </div>
        <div id="page-default-banner-image-mobile" class="visible-sm visible-xs">
          <div class="manic-image-container has-window-height">
            <img src="" data-image-tablet="images_cms/rest/rest-banner.jpg"
                        data-image-mobile="images_cms/rest/rest-banner-mobile.jpg">
          </div>
        </div>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div id="page-default-banner-copy">
                  <h1>Space to Recharge</h1>
                  <h3>Comfortable places to rest <br class="hidden-xs hidden-sm">and refresh at every Kafnu.</h3>
          ...
          <div class="row">
            <div class="col-md-10 col-md-offset-1">
              ...
              <div id="page-play-slider-title">
                <h3>Sometimes things move too fast. We work too hard. We need a break. Kafnu provides rest facilities so you can be your best self always.</h3>
              ...
              <div id="page-play-slider-container">
                ...
                <div id="page-play-slider" class="kafnu-slick-slider">
                  <div class="page-play-slider-item">
                    <div class="manic-image-container">
                      <img src="" 
                        data-image-desktop="images_cms/rest/rest-slider-1.jpg"
                        data-image-tablet="images_cms/rest/rest-slider-1.jpg"
                        data-image-mobile="images_cms/rest/rest-slider-1.jpg" alt="">
                    </div>
                  </div>
                  <!-- <div class="page-play-slider-item">
                    <div class="manic-image-container">
              ...
              <div class="page-play-extra-content-container drink-tab active-tab">
                <div id="page-play-extra-content">
                  <div class="manic-image-container hidden-xs hidden-sm">
                    <img src="" data-image-desktop="images_cms/rest/rest-tab-1.jpg"
                                data-image-tablet="images_cms/rest/rest-tab-1.jpg"
                                data-image-mobile="images_cms/rest/rest-tab-1.jpg" alt="">
                  </div>

                  <div class="text-container">
                    <h2>Relax</h2>
                    <h3>Crash pods. Shower facilities. Day beds. Meditation spots. Inspiring views.</h3>
                  </div>
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-4 col-md-offset-1 v-align-col">
                <div class="text-container">
                  <h3>How do you rest after a long day? <br class="hidden-xs hidden-sm"> Come by one of our spaces and take a powernap – we’ll set the alarm. </h3>                  
                </div>
            ...
            --><div class="col-md-7 v-align-col">
              <div class="page-play-location-content-container">
                <div class="manic-image-container">
                  <img src="" data-image-desktop="images_cms/rest/rest-content.jpg"
                                data-image-tablet="images_cms/rest/rest-content.jpg"
                                data-image-mobile="images_cms/rest/rest-content.jpg" alt="">
                </div>
              </div>
...
file_put_contents('rest.html', ob_get_contents());
