            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div id="page-default-banner-copy">
                  ...
                  <!-- <h5></h5> -->
                  <a href="kafnuhk.html" class="square-cta border-version">Kafnu Hong Kong Now Open. Learn More.</a>
              ...
              <div class="home-box-item-column">
                <div class="col-md-4 no-padding">              
                  <div class="home-box-item text-version-02 no-link-version">
                    ...
                    <div class="text-container">
                      <h4>Kafnu <br class="visible-xs">Bangalore</h4>                      
                      <h6>Opening in 2018</h6>
                    </div>
                    <!-- <div class="cta-container">
              ...
              <div class="home-box-item-column">
                <div class="col-md-4 no-padding">              
                  <div class="home-box-item text-version-02 no-link-version">
                    <div class="overlay-bg"></div>
                    <div class="text-container">
                      <h4>Kafnu <br class="visible-xs">Colombo</h4>                      
                      <h6>Opening in 2018</h6>
                    </div>
                    <!-- <div class="cta-container">
                      <a href="#" class="plus-icon"></a>
              ...
              <div class="home-box-item-column">
                <div class="col-md-4 no-padding">              
                  <div class="home-box-item text-version-02 no-link-version">
                    <div class="overlay-bg"></div>
                    <div class="text-container">                    
                      <h4>Kafnu <br class="visible-xs">Ho Chi Minh City</h4>
                      <h6>Opening in 2018</h6>
                    </div>
                    <!-- <div class="cta-container">
                      <a href="#" class="plus-icon"></a>
              ...
              <div class="home-box-item-column last-row-version">
                <div class="col-md-4 no-padding">              
                  <div class="home-box-item text-version-02 no-link-version">
                    <div class="overlay-bg"></div>
                    <div class="text-container">                    
                      <h4>Kafnu <br class="visible-xs">Ringwood (Melbourne)</h4>                      
                      <h6>Opening in 2018</h6>
                    </div>
                    <!-- <div class="cta-container">
                      <a href="#" class="plus-icon"></a>
              ...
              <div class="home-box-item-column last-row-version">
                <div class="col-md-4 no-padding">              
                  <div class="home-box-item text-version-02 no-link-version">
                    <div class="overlay-bg"></div>
                    <div class="text-container">                    
                      <h4>Kafnu <br class="visible-xs">Sydney</h4>
                      <h6>Opening in 2018</h6>
                    </div>
                    <!-- <div class="cta-container">
                      <a href="#" class="plus-icon"></a>
