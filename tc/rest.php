            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div id="page-default-banner-copy">
                  <h1>在這裡充電一下再出發</h1>
                  <h3>每一間 Kafnu 都有的舒適空間，<br class"hidden-xs hidden-sm">讓你得以徹底放鬆休息，重獲力量。</h3>
          ...
          <div class="row">
            <div class="col-md-10 col-md-offset-1">
              ...
              <div id="page-play-slider-title">
                <h3>當我們花去大把時間工作，把自己逼得太緊，彷彿一切都超速運轉時，我們很需要休息一下。Kafnu 為你準備多種設施，讓你選擇最合適的放鬆方式。</h3>
              ...
              <div class="page-play-extra-content-container drink-tab active-tab">
                <div id="page-play-extra-content">
                  ...
                  <div class="text-container">
                    <h2>放鬆</h2>
                    <h3>休憩艙、淋浴設施、沙發床、冥想地點與窗外絕美景致。</h3>
                  </div>
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-4 col-md-offset-1 v-align-col">
                <div class="text-container">
                  <h3>忙碌的一天結束時，你想選擇甚麼方式讓自己放鬆下來？ <br class="hidden-xs hidden-sm"> 來體驗 Kafnu 為你準備多樣化的休憩設施吧！</h3>                  
                </div>
