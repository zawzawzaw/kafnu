            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div id="page-default-banner-copy">
                  <h1>為創業者與創意人打造之<br class="hidden-xs">全新工作生態系</h1>
                  <h3>社群/空間/創客平台</h3>
                  <!-- <h5></h5> -->
                  <a href="kafnuhk.html" class="square-cta border-version">Kafnu Hong Kong 現已開幕. 了解更多.</a>
          ...
          <div id="home-box-items-container" class="hidden-xs hidden-sm">
              ...
              <div class="home-box-item-column">
                <div class="col-md-4 no-padding">              
                  <div class="home-box-item text-version-02 no-link-version">
                    ...
                    <div class="text-container">
                      <h4>Kafnu <br class="visible-xs">班加羅爾</h4>                      
                      <h6>2018 即將開業</h6>
                    </div>
                    <!-- <div class="cta-container">
              ...
              <div class="home-box-item-column">
                <div class="col-md-4 no-padding">              
                  <div class="home-box-item text-version-02 no-link-version">
                    <div class="overlay-bg"></div>
                    <div class="text-container">
                      <h4>Kafnu <br class="visible-xs">科倫坡</h4>                      
                      <h6>2018 即將開業</h6>
                    </div>
                    <!-- <div class="cta-container">
                      <a href="#" class="plus-icon"></a>
              ...
              <div class="home-box-item-column">
                <div class="col-md-4 no-padding">              
                  <div class="home-box-item text-version-02 no-link-version">
                    <div class="overlay-bg"></div>
                    <div class="text-container">                    
                      <h4>Kafnu <br class="visible-xs">胡志明市</h4>
                      <h6>2018 即將開業</h6>
                    </div>
                    <!-- <div class="cta-container">
                      <a href="#" class="plus-icon"></a>
            ...
            <div class="row">
              ...
              <div class="home-box-item-column last-row-version">
                <div class="col-md-4 no-padding">              
                  <div class="home-box-item text-version-02 no-link-version">
                    <div class="overlay-bg"></div>
                    <div class="text-container">                    
                      <h4>Kafnu <br class="visible-xs">墨爾本</h4>
                      <h6>2018 即將開業</h6>
                    </div>
                    <!-- <div class="cta-container">
                      <a href="#" class="plus-icon"></a>
              ...
              <div class="home-box-item-column last-row-version">
                <div class="col-md-4 no-padding">              
                  <div class="home-box-item text-version-02 no-link-version">
                    <div class="overlay-bg"></div>
                    <div class="text-container">                                          
                      <h4>Kafnu <br class="visible-xs">雪梨</h4>
                      <h6>2018 即將開業</h6>
                    </div>
                    <!-- <div class="cta-container">
                      <a href="#" class="plus-icon"></a>
              ...
              <div class="home-box-item-column coming-soon-version">
                <div class="col-md-4 no-padding">              
                  <div class="home-box-item text-version-02 no-link-version coming-soon">
                    <div class="overlay-bg"></div>
                    <div class="text-container">                    
                      <h4>即將來臨</h4>
                      <!-- <h6>Coming soon</h6> -->
            ...
            <div id="home-box-items-container-mobile-toggle">
              <div class="row">
                <div class="col-sm-12 no-padding">
                  <h4>2018 即將 <br class="visible-xs">開業</h4>
                  <div class="cta-container">
            ...
            <div id="home-box-items-container-mobile">
              ...
              <div class="row no-margin">
                <div class="home-box-item-column no-link-version">
                  <div class="col-sm-12 no-padding">              
                    <div class="home-box-item text-version-02 no-link-version">
                      <!-- <div class="manic-image-container overlay-bg-mobile">
                        <img src="" data-image-mobile="images_cms/home/hong-kong-box-bg-mobile.jpg" alt="">
                      </div> -->
                      <div class="text-container">
                        <h4>Kafnu <br class="visible-xs">班加羅爾</h4>                                            
                      </div>                    
                ...
                <div class="home-box-item-column no-link-version">
                  <div class="col-sm-12 no-padding">              
                    <div class="home-box-item text-version-02 no-link-version">
                      <!-- <div class="manic-image-container overlay-bg-mobile">
                        <img src="" data-image-mobile="images_cms/home/taipei-box-bg-mobile.jpg" alt="">
                      </div> -->
                      <div class="text-container">
                        <h4>Kafnu <br class="visible-xs">科倫坡</h4>                                                 
                      </div>                    
                ...
                <div class="home-box-item-column no-link-version">
                  <div class="col-sm-12 no-padding">              
                    <div class="home-box-item text-version-02 no-link-version">
                      <!-- <div class="manic-image-container overlay-bg-mobile">
                        <img src="" data-image-mobile="images_cms/home/melbourne-box-bg-mobile.jpg" alt="">
                      </div> -->
                      <div class="text-container">
                        <h4>Kafnu <br class="visible-xs">胡志明市</h4>                    
                      </div>                    
                ...
                <div class="home-box-item-column no-link-version">
                  <div class="col-sm-12 no-padding">              
                    <div class="home-box-item text-version-02 no-link-version">
                      <!-- <div class="manic-image-container overlay-bg-mobile">
                        <img src="" data-image-mobile="images_cms/home/singapore-box-bg-mobile.jpg" alt="">
                      </div> -->
                      <div class="text-container">
                        <h4>Kafnu <br class="visible-xs">墨爾本</h4>   
                      </div>                    
                ...
                <div class="home-box-item-column no-link-version">
                  <div class="col-sm-12 no-padding">              
                    <div class="home-box-item text-version-02 no-link-version">
                      <!-- <div class="manic-image-container overlay-bg-mobile">
                        <img src="" data-image-mobile="images_cms/home/seoul-box-bg-mobile.jpg" alt="">
                      </div> -->
                      <div class="text-container">                        
                        <h4>Kafnu <br class="visible-xs">悉尼</h4>                                
                      </div>                    
                    </div>
                  </div>
                </div>
