...
<header id="header-mobile" class="visible-md visible-sm visible-xs">
  ...
  <div id="header-mobile-content-container">
    <div id="header-mobile-logo-container">
      <a id="header-mobile-logo" href="index.html" title="Transmedic - Advancing Medical Technologies"></a>
    </div>
...
<div id="header-mobile-expand">
  ...
  <div id="header-mobile-nav-container">
    <nav>
      <ul>
        <li><a href="live.html">生活</a></li>
        <li><a href="work.html">工作</a></li>
        <li><a href="play.html">玩樂</a></li>
        <li><a href="learn.html">學習</a></li>
        <li><a href="rest.html">休憩</a></li>
        <li><a href="community.html">社群</a></li>
        <li><a href="index.html#location">我們的地點</a></li>
