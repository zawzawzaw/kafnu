  ...
  <?php if ($is_debug == true): ?>
    ...
    <script type="text/javascript" src="kafnu_assets/libs/wow/wow.min.js"></script>
  ...
  <?php else: ?>
    ...
    <script type="text/javascript">
      ...
      var PAGE_LIBRARY        = "kafnu_assets/js/minified/libraries-home.min.js";
      var PAGE_JS             = "kafnu_assets/js/minified/page-home.min.js";
